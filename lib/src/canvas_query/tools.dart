...
class CqTools {
  ...
  static void _initBlend(CanvasElement below, var above, num mix, Function blendingFunction(List<int> pixels, List<int> belowPixels, List<int> abovePixels, num mix)) {
